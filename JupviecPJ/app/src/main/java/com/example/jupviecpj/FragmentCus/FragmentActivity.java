...
import com.example.jupviecpj.Adapter.ActiveAdapter;
...
public class FragmentActivity extends Fragment {
    ...
    private ArrayList<Active> activesList;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        tvTitleToolbar.setText("Hoạt động");
        AppCompatActivity activity = (AppCompatActivity) getActivity();
        activity.setSupportActionBar(toolbar);
        activity.getSupportActionBar().setDisplayShowTitleEnabled(false);

        //Set adapter và RecyclerView
        mRV = v.findViewById(R.id.recyclerView);
        mLayoutManager = new LinearLayoutManager(getContext());
        mRV.setLayoutManager(mLayoutManager);
        activesList = Active.init();
        activeAdapter = new ActiveAdapter(getContext(), R.layout.list_active, activesList);
        mRV.setAdapter(activeAdapter);
